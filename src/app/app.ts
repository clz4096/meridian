...
import { chart as baseChart } from '@/ui/charts/chart';
import {
  PERIOD_LABEL,
  bodyweightGoal,
  bodyweightSeries,
  ...
  xpSeries,
  type Period,
} from '@/ui/charts/progress';
import type { AppHost } from '@/core/appHost';
import type { AppState, StoreKey } from '@/core/storage/appState';
import { renderHubHTML, type HubStat } from '@/ui/hubView';
