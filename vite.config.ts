  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // /preview/* holds a self-contained design prototype; keep it out of the
        // main precache and let its navigations hit the network. (Temporary — torn
        // down once the previewed design is finalized.)
        globIgnores: ['preview/**'],
