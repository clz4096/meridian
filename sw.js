const CACHE='meridian-v13';   // bump to invalidate old cached app shell
const ASSETS=['./','./index.html','./manifest.webmanifest','./meridian-landing.js','./icon.svg','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
